...
app.use(express.static('public')); // Si tienes archivos estáticos

app.post('/enviar-correo', (req, res) => {
    const transporter = nodemailer.createTransport({
        service: 'Gmail',
        auth: {
            user: 'yelfrymaster@gmail.com',
            pass: 'Onepiece220'
        }
    });

    const mailOptions = {
        from: 'yelfrymaster@gmail.com',
        to: 'yelfrymaster@gmail.com',
        subject: 'Mensaje de contacto',
        html: `
            <h2>¡Nuevo mensaje de contacto!</h2>
            <p>Nombre: ${req.body.nombre}</p>
            <p>Cédula: ${req.body.cedula}</p>
